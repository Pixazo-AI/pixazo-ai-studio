  ...
  return (
    <div className="animate-fade-in">
      <div className="text-center mb-8">
        <div className="inline-flex items-center gap-2 bg-primary-50 text-primary-700 px-4 py-2 rounded-full text-sm font-medium mb-3">
      ...
      <div className="max-w-2xl mx-auto space-y-4">
        <div>
          ...
          <textarea
            ...
            rows={4}
            disabled={isLoading}
            className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 resize-none transition-all disabled:opacity-50 disabled:bg-gray-50"
          />
        </div>
          ...
          <div className="flex flex-wrap gap-2">
            {PRESET_PROMPTS.map((preset, i) => (
              <button
                ...
                disabled={isLoading}
                className="text-xs px-3 py-1.5 bg-gray-100 hover:bg-primary-50 hover:text-primary-700 rounded-full transition-colors disabled:opacity-50"
              >
